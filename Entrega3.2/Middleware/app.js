...
console.log(`\x1b[36m SUMA ${"Suma: ", middleware.suma(input)} \x1b[0m`);
console.log(`\x1b[31m RESTA ${"Resta: ", middleware.resta(input)} \x1b[0m`);
console.log(`\x1b[32m MULTIPLICACIÓ ${"Multiplicació: ", middleware.multiplicacio(input)} \x1b[0m`);